...
const Contacts = () => {
  return (
    <div className="contacts">
      ...
      <p className="info">Skontaktuj się z nami w razie problemów z Twoim urządzeniem mobilnym.</p>
      <ul className="contact-list">
        <li className="contact-item">Telefon: 123-456-789</li>
        <li className="contact-item">E-mail: kontakt@serwis-mobilny.pl</li>
        <li className="contact-item">Adres: ul. Józefa Lewartowskiego 17, 00-169 Warszawa</li>
      </ul>
